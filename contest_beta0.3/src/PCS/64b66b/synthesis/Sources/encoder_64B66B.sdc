...
set_clock_uncertainty -hold  0.018 clock
set_auto_disable_drc_nets -clock false

### Crude constraint from clock to output 
set_max_delay -to [get_ports -filter port_direction==out *] 0.7

### Crude constraint from input to flop
set_max_delay -from [get_ports -filter port_direction==in *] 0.25
