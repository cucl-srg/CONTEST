...
##set_clock_uncertainty -setup 0.0 CLK_IN
##set_clock_uncertainty -hold  0.02 CLK_IN
###set_auto_disable_drc_nets -clock false

### Crude constraint from clock to output
##set_max_delay -to [get_ports -filter port_direction==out *] 0.08

### Crude constraint from input to flop
##set_max_delay -from [get_ports -filter port_direction==in *] 0.05
